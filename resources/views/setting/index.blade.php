					...
					<form action="{{ url('setting/update') }}" method="POST" enctype="multipart/form-data"
						...
						<div class="row">
							<div class="col-xl-6">
								...
								<div class="form-group">
									<label>Batas Pendaftar</label>
									<input name="registration_limit" type="number" value="{{ old('registration_limit', $setting->registration_limit) }}" class="form-control @error('registration_limit') is-invalid @enderror">
								...
								<div class="form-group">
									...
									<label class="mt-2" style="margin-left: 20px;">
										<input type="checkbox" name="registration_status" value="1" class="custom-switch-input" @if (old('registration_status', $setting->registration_status) == 1) checked @endif>
										<span class="custom-switch-indicator"></span>
										<span class="custom-switch-description">Aktifkan pendaftaran</span>
									</label>
								</div>
