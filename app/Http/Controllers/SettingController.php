...
class SettingController extends Controller
{
    ...
    public function settingUpdate(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'registration_limit' => 'nullable|integer|min:0', // Tambahkan validasi ini
            'registration_status' => 'nullable|boolean', // Tambahkan validasi ini
        ]);
        ...
        $setting = DB::table('setting')->first(); // Gunakan first() daripada get()->first()
        ...
        $post['registration_limit'] = $request->registration_limit; // Tambahkan ini
        $post['registration_status'] = $request->has('registration_status') ? 1 : 0; // Tambahkan ini
